...
async def on_startup(dp: Dispatcher):
    ...
    print(colorama.Fore.LIGHTBLUE_EX + "Developer: https://t.me/JangoCT")
    print(colorama.Fore.LIGHTBLUE_EX + "TG Channel: https://t.me/+BJXzGgeolC9jYjgy")
    print(colorama.Fore.LIGHTBLUE_EX + "Forum: https://t.me/+BJXzGgeolC9jYjgy")
